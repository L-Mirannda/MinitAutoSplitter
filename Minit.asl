state("minit")
{
	int reset : 0x161898, 0x0;
	int isPaused : 0x40761C, 0x0, 0x10, 0x4, 0x55C, 0xCC;
	int isDead : 0x40761C, 0x0, 0x28, 0x1C, 0xCC;
	int isItemload : 0x40761C, 0x0, 0x0, 0x4, 0x4BC, 0xCC;
	int mapcode : 0x617EA0;
}
